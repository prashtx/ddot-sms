...
var API_KEY = process.env.OBA_KEY || "TEST";
//var AGENCY = 'Detroit Department of Transportation';
var AGENCY = process.env.OBA_AGENCY || "DDOT";
...
module.exports = (function() {
  ...
  self.getRoutes = function() {
    ...
    request.get(apiUrl("routes-for-agency", AGENCY), function(
      error,
      resp,
      body
    ) {
  ...
  self.getStopsForLocation = function(coords) {
    ...
    request.get(apiUrl("stops-for-location", null, coords), function(
      error,
      resp,
      body
    ) {
  ...
  self.getArrivalsForStop = function(stopId) {
    ...
    request.get(
      apiUrl("arrivals-and-departures-for-stop", makeFullId(stopId), query),
